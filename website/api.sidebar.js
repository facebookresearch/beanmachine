...
'api/overview',
{
  ...
  collapsed: true,  items: ["api/beanmachine.ppl.compiler.patterns", "api/beanmachine.ppl.compiler.patterns.AnyPattern", "api/beanmachine.ppl.compiler.patterns.AtomicPattern", "api/beanmachine.ppl.compiler.patterns.AttributeSubpattern", "api/beanmachine.ppl.compiler.patterns.BoolPattern", "api/beanmachine.ppl.compiler.patterns.EmptyListPattern", "api/beanmachine.ppl.compiler.patterns.Fail", "api/beanmachine.ppl.compiler.patterns.FailPattern", "api/beanmachine.ppl.compiler.patterns.FloatPattern", "api/beanmachine.ppl.compiler.patterns.HeadTail", "api/beanmachine.ppl.compiler.patterns.IntPattern", "api/beanmachine.ppl.compiler.patterns.ListAll", "api/beanmachine.ppl.compiler.patterns.ListAny", "api/beanmachine.ppl.compiler.patterns.ListPattern", "api/beanmachine.ppl.compiler.patterns.MatchAny", "api/beanmachine.ppl.compiler.patterns.MatchEvery", "api/beanmachine.ppl.compiler.patterns.MatchResult", "api/beanmachine.ppl.compiler.patterns.Negate", "api/beanmachine.ppl.compiler.patterns.NonePattern", "api/beanmachine.ppl.compiler.patterns.PatternBase", "api/beanmachine.ppl.compiler.patterns.PredicatePattern", "api/beanmachine.ppl.compiler.patterns.StringPattern", "api/beanmachine.ppl.compiler.patterns.Subpattern", "api/beanmachine.ppl.compiler.patterns.Success", "api/beanmachine.ppl.compiler.patterns.TypePattern", "api/beanmachine.ppl.compiler.patterns.abstractmethod", "api/beanmachine.ppl.compiler.patterns.attribute", "api/beanmachine.ppl.compiler.patterns.is_any", "api/beanmachine.ppl.compiler.patterns.match", "api/beanmachine.ppl.compiler.patterns.match_any", "api/beanmachine.ppl.compiler.patterns.match_every", "api/beanmachine.ppl.compiler.patterns.negate", "api/beanmachine.ppl.compiler.patterns.to_pattern", "api/beanmachine.ppl.compiler.patterns.type_and_attributes"],
}, {
  type: 'category',
  ...
  collapsed: true,  items: ["api/beanmachine.ppl.diagnostics", "api/beanmachine.ppl.diagnostics.Diagnostics", {
  type: 'category',
