...
github: https://github.com/facebookresearch/beanmachine/blob/v0.2.0/tutorials/Bayesian_Logistic_Regression.ipynb
colab: https://colab.research.google.com/github/facebookresearch/beanmachine/blob/v0.2.0/tutorials/Bayesian_Logistic_Regression.ipynb
---
...
<LinkButtons
  githubUrl="https://github.com/facebookresearch/beanmachine/blob/v0.2.0/tutorials/Bayesian_Logistic_Regression.ipynb"
  colabUrl="https://colab.research.google.com/github/facebookresearch/beanmachine/blob/v0.2.0/tutorials/Bayesian_Logistic_Regression.ipynb"
/>
...
<BokehFigure data={require('./assets/plot_data/0767360f-a44d-45ce-ad72-01958e2edaf5.json')} />
...
<BokehFigure data={require('./assets/plot_data/2cfac753-c0ad-49d1-9524-9a3051c61419.json')} />
...
<BokehFigure data={require('./assets/plot_data/38f07ddc-c7f5-4ad1-8a47-7b8cfefaf248.json')} />
...
<BokehFigure data={require('./assets/plot_data/db9c0893-2142-4fd2-a851-5c919e4ac96e.json')} />
...
<BokehFigure data={require('./assets/plot_data/d4b08183-767e-49f9-b1a7-9e84fcbbd0b0.json')} />
