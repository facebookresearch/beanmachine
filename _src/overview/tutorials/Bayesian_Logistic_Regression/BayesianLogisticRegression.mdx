...
github: 
  https://github.com/facebookresearch/beanmachine/blob/v0.2.0/tutorials/Bayesian_Logistic_Regression.ipynb
colab: 
  https://colab.research.google.com/github/facebookresearch/beanmachine/blob/v0.2.0/tutorials/Bayesian_Logistic_Regression.ipynb
---
