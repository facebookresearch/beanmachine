...
github: 
  https://github.com/facebookresearch/beanmachine/blob/v0.2.0/tutorials/Hidden_Markov_model.ipynb
colab: 
  https://colab.research.google.com/github/facebookresearch/beanmachine/blob/v0.2.0/tutorials/Hidden_Markov_model.ipynb
---
