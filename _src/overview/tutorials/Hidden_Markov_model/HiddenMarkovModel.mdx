...
<LinkButtons
  githubUrl="https://github.com/facebookresearch/beanmachine/blob/v0.1.2/tutorials/Hidden_Markov_model.ipynb"
  colabUrl="https://colab.research.google.com/github/facebookresearch/beanmachine/blob/v0.1.2/tutorials/Hidden_Markov_model.ipynb"
/>
