...
github: https://github.com/facebookresearch/beanmachine/blob/v0.2.0/tutorials/Hidden_Markov_model.ipynb
colab: https://colab.research.google.com/github/facebookresearch/beanmachine/blob/v0.2.0/tutorials/Hidden_Markov_model.ipynb
---
...
<LinkButtons
  githubUrl="https://github.com/facebookresearch/beanmachine/blob/v0.2.0/tutorials/Hidden_Markov_model.ipynb"
  colabUrl="https://colab.research.google.com/github/facebookresearch/beanmachine/blob/v0.2.0/tutorials/Hidden_Markov_model.ipynb"
/>
...
state $X_{n-1}$. Thus, we would also like to jointly propose new values for all $X$ — it
is very likely that the value of a hidden state $X_n$ becomes invalid and needs to be
