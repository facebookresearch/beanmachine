...
path: 
  overview/tutorials/GMM_with_2_dimensions_and_4_components/GmmWith2DimensionsAnd4Components
nb_path: tutorials/GMM_with_2_dimensions_and_4_components.ipynb
github: 
  https://github.com/facebookresearch/beanmachine/blob/v0.2.0/tutorials/GMM_with_2_dimensions_and_4_components.ipynb
colab: 
  https://colab.research.google.com/github/facebookresearch/beanmachine/blob/v0.2.0/tutorials/GMM_with_2_dimensions_and_4_components.ipynb
---
...
<PlotlyFigure data={require('./assets/plot_data/20daa748-3996-48d1-8519-a4767e24b053.json')} />
...
<PlotlyFigure data={require('./assets/plot_data/099b0943-3337-4c28-b038-92a6c8c3bbaf.json')} />
...
<PlotlyFigure data={require('./assets/plot_data/668a0359-ab11-4225-a7c1-87a7d9e14d7d.json')} />
