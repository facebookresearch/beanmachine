...
<LinkButtons
  githubUrl="https://github.com/facebookresearch/beanmachine/blob/v0.1.1/tutorials/Sparse_Logistic_Regression.ipynb"
  colabUrl="https://colab.research.google.com/github/facebookresearch/beanmachine/blob/v0.1.1/tutorials/Sparse_Logistic_Regression.ipynb"
/>
...
<BokehFigure data={require('./assets/plot_data/beta-marginals-plot.json')} />
...
<BokehFigure data={require('./assets/plot_data/lambda-marginals-plot.json')} />
...
<BokehFigure data={require('./assets/plot_data/betas-density-plot.json')} />
...
<BokehFigure data={require('./assets/plot_data/log-prob-plot.json')} />
...
<BokehFigure data={require('./assets/plot_data/predicted-data-plot.json')} />
...
<BokehFigure data={require('./assets/plot_data/data-point11-plot.json')} />
...
<BokehFigure data={require('./assets/plot_data/beta-marginals-mh-plot.json')} />
...
<BokehFigure data={require('./assets/plot_data/lambda-marginals-mh-plot.json')} />
...
<BokehFigure data={require('./assets/plot_data/log-prob-mh-plot.json')} />
...
<BokehFigure data={require('./assets/plot_data/german-log-prob-plot.json')} />
...
<BokehFigure data={require('./assets/plot_data/german-betas-density-plot.json')} />
...
<BokehFigure data={require('./assets/plot_data/roc-plot.json')} />
