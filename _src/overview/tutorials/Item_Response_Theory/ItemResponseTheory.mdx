...
github: 
  https://github.com/facebookresearch/beanmachine/blob/v0.2.0/tutorials/Item_Response_Theory.ipynb
colab: 
  https://colab.research.google.com/github/facebookresearch/beanmachine/blob/v0.2.0/tutorials/Item_Response_Theory.ipynb
---
