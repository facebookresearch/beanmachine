...
<LinkButtons
  githubUrl="https://github.com/facebookresearch/beanmachine/blob/v0.1.1/tutorials/Item_Response_Theory.ipynb"
  colabUrl="https://colab.research.google.com/github/facebookresearch/beanmachine/blob/v0.1.1/tutorials/Item_Response_Theory.ipynb"
/>
