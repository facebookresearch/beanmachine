...
<BokehFigure data={React.useMemo(() => require("./prior_exponential.json"), [])} />
...
<BokehFigure data={React.useMemo(() => require("./prior_poisson.json"), [])} />
...
<BokehFigure data={React.useMemo(() => require("./posterior_rate_static.json"), [])} />
