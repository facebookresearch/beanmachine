...
<!-- ;;;
export const BokehFigure = ({ plotData }) => {
  return (
    <div id={plotData["target_id"]}>
      <BrowserOnly>
...
import plotDataPriorExponential from "./prior_exponential.json";
import plotDataPriorPoisson from "./prior_poisson.json";
import plotDataPosteriorRate from "./posterior_rate_static.json";
;;; -->
...
<!-- ;;; <BokehFigure plotData={plotDataPriorExponential} /> -->
...
<!-- ;;; <BokehFigure plotData={plotDataPriorPoisson} /> -->
...
<!-- ;;; <BokehFigure plotData={plotDataPosteriorRate} /> -->
