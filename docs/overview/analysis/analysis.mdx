...
import plotDataPosteriorRate from "./posterior_rate_dynamic.json";
import plotDataMCMCTrace from "./mcmc_trace.json";
import plotDataMCMCAutocorrelation from "./mcmc_autocorr.json";
;;; -->
...
<!-- ;;; <BokehFigure plotData={plotDataMCMCTrace} /> -->

![](/img/autocorrelation_reproduction_rate.png)

<BokehFigure plotData={plotDataMCMCAutocorrelation} />
