...
class GlobalMetropolisAdapatedLangevinAlgorithm(GlobalHamiltonianMonteCarlo):
    """
    Global (multi-site) Metropolis Adapted Langevin Algorithm [1] sampler. This global sampler blocks
...
class SingleSiteMetropolisAdapatedLangevinAlgorithm(SingleSiteHamiltonianMonteCarlo):
    """
    Single site Metropolis Adapted Langevin Algorithm [1] sampler. During inference, each random
