...
def _node_factories(bmg: BMGraphBuilder) -> Dict[Type, Callable]:
    return {
        ...
        bn.BroadcastNode: bmg.add_broadcast,
        ...
        bn.FillMatrixNode: bmg.add_fill_matrix,
        ...
        bn.MatrixComplementNode: bmg.add_matrix_complement,
        bn.MatrixExpNode: bmg.add_matrix_exp,
        bn.MatrixLogNode: bmg.add_matrix_log,
        bn.MatrixLog1mexpNode: bmg.add_matrix_log1mexp,
        bn.MatrixMultiplicationNode: bmg.add_matrix_multiplication,
        bn.MatrixNegateNode: bmg.add_matrix_negate,
        bn.MatrixPhiNode: bmg.add_matrix_phi,
...
def _constant_factories(bmg: BMGraphBuilder) -> Dict[Type, Callable]:
    return {
        ...
        bn.ConstantProbabilityMatrixNode: bmg.add_probability_matrix,
