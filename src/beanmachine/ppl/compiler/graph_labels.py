...
_node_labels = {
    ...
    bn.LessThanNode: "<",
    bn.LKJCholeskyNode: "LKJCholesky",
    ...
    bn.MatrixComplementNode: "MatrixComplement",
    bn.MatrixExpNode: "MatrixExp",
    bn.MatrixLogNode: "MatrixLog",
    bn.MatrixLog1mexpNode: "MatrixLog1mexp",
    bn.MatrixMultiplicationNode: "@",
    bn.MatrixNegateNode: "MatrixNegate",
    bn.MatrixPhiNode: "MatrixPhi",
    ...
    bn.ToNegativeRealMatrixNode: "ToNegRealMatrix",
...
_node_error_labels = {
    ...
    bn.LKJCholeskyNode: "LKJ Cholesky",
    bn.Log1mexpNode: "log1mexp",
    bn.LogisticNode: "logistic",
    ...
    bn.ToNegativeRealMatrixNode: "'to negative real matrix'",
...
_edge_labels = {
    ...
    bn.BroadcastNode: ["value", "rows", "columns"],
    ...
    bn.FlatNode: _none,
    bn.FillMatrixNode: ["value", "rows", "columns"],
    ...
    bn.MatrixComplementNode: _operand,
    bn.MatrixExpNode: _operand,
    bn.MatrixMultiplicationNode: _left_right,
    bn.MatrixLogNode: _operand,
    bn.MatrixLog1mexpNode: _operand,
    bn.MatrixNegateNode: _operand,
    bn.MatrixPhiNode: _operand,
