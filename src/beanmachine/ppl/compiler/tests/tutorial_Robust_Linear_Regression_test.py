...
samples_mh = amh.infer(
    queries=queries,  # Now passing by keyword naming is redundant
    observations=observations,  # Now passing by keyword naming is redundant
    num_samples=num_samples,  # ow passing by keyword naming is redundant
    num_chains=num_chains,  # Now passing by keyword naming is redundant
)
