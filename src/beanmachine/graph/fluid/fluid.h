...
Current limitations:
- This interface is not concurrency-safe because there is a global node pool.
- The graph-building function is recursive and therefore limited by stack size.
  This limitation could be eliminated by rewriting the code to use a
